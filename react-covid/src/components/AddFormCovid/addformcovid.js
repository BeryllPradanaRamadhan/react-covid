        ...
        <div className={styles.form__right}>
          ...
          <form onSubmit={handleSubmit}>
            <div className={styles.form__group}>
              ...
              <select type="text" name="provinsi" id="provinsi" value={provinsi} onChange={handleProvinsi} >
            ...
            <div className={styles.form__group}>
              ...
              <select type="text" name="status" id="status" value={status} onChange={handleStatus} >
              <option value="">Pilih</option>
            ...
            <div className={styles.jumlah}>
              ...
              <input
                ...
                id="jumlah"
                name="jumlah"
                className={styles.input__jumlah}
